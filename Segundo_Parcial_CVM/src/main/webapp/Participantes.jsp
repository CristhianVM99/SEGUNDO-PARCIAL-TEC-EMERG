...
<html lang="en">
  <head>
    ...
    <title>Segundo Parcial | Tecnologias Emergentes II</title>
      ...
      <div class="container">
          ...
          <table class="table table-dark table-striped">
              ...
              <tr>
                  ...
                  <c:forEach var="item2" items="${lista_seminarios}">
                      <c:if test="${item.id_seminario==item2.id}">
                          <td>${item2.titulo}</td>
                      </c:if>
                  </c:forEach>
                  <td><input type="checkbox" id="cbox2"
